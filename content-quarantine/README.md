...
Assets and records that exist in the source material but are **not confirmed** as
current Foundry content. Nothing here may be copied into `public/` or the CMS until a
content owner approves it.
...
The Bright SVG itself is not committed here either — it lives in the same undelivered
source archive as the brand masters. This file records the decision so it cannot be
silently reversed.
